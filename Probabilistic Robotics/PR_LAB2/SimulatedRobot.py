    ...
    **All Robot simulation classes must derive from this class** .
    ...
    def __init__(self, xs0, map=[], * args):
        ...
        * **visualizationInterval** : time-steps interval between two consecutive frames of the animation
        ...
        # self.vehicleIcon = VehicleIcon('PR_LAB2-master\DifferentialDrive.png', scale=5, rotation=90) # Image of the robot to be used in the animation. By default it uses the image of a Differential Mobile Robot.
        self.vehicleIcon = VehicleIcon('PR_LAB2-master\DifferentialDrive.png', scale=1, rotation=90)
        ...
        for i in range(len(map)):
            m1 ,m2= map[i]
            m1[0]
            feature_circle.append(patches.Circle((m1[0], m2[0]), 0.5, fc='r'))
