...
kSteps = 500# number of simulation steps
...
# print(x_range , y_range , cell_size , range_dx)
...
p0.histogram_2d  + (1/400)

grl = GL_3DOFDifferentialDrive(dx_max, dy_max, range_dx, range_dy, p0, index, kSteps, robot, x0)

uk = np.array([[4, 1]]).T

# print(robot.ReadRanges()) 
# g = grl.MeasurementProbability(robot.ReadRanges())*p0
# g.plot_histogram()
# plt.pause(10)
