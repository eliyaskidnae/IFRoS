...
class HF:
    ...
    def StateTransitionProbability_4_uk(self,uk):
       ...
       :param uk: control input. In localization, this is commonly the robot displacement. 
         For example, in the case of a differential drive robot, this is the robot displacement 
         in the robot frame commonly computed through the odometry.
    ...
    def Update(self,pk_hat, zk):
        ...
        self.pk = self.MeasurementProbability(zk)
